Profile:        RefusedResearchConsent
Parent:         Consent
Id:             refused-research-consent
Title:          "Refused Research Consent"
Description:    "Consent to indicate that a patient refused to give the access to its EHR for research purpose"
* status = #rejected
